...
public class ProfessionController {
	...
	public String list(Model model) {
		...
		return "professions-view";
	}

	@GetMapping("/create")
	public String createForm(Model model) {
		model.addAttribute("form", new ProfessionDto());
		return "professions-form";
	}

	@GetMapping("/{id}/edit")
	public String editForm(@PathVariable("id") long id, Model model) {
		model.addAttribute("form", mapper.toProfessionDto(service.getById(id)));
	...
	public String save(@RequestParam(value = "id", required = false) Long id,
			@Valid @ModelAttribute("form") ProfessionDto form, BindingResult result, Model model,
